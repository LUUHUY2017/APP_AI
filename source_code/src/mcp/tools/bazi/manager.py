...
class BaziManager:
    ...
    def init_tools(self, add_tool, PropertyList, Property, PropertyType):
        ...
        初始化并注册所有八字命理工具。
        '''
        analyze_marriage_compatibility = analyze_marriage_compatibility
        analyze_marriage_timing = analyze_marriage_timing
        import marriage_tools
        build_bazi_from_lunar_datetime = build_bazi_from_lunar_datetime
        build_bazi_from_solar_datetime = build_bazi_from_solar_datetime
        get_bazi_detail = get_bazi_detail
        get_chinese_calendar = get_chinese_calendar
        get_solar_times = get_solar_times
        import tools
        bazi_detail_props = PropertyList([
            ...
            Property('eight_char_provider_sect', PropertyType.INTEGER, default_value = 2)])
        ...
        solar_times_props = PropertyList([
            Property('bazi', PropertyType.STRING)])
        ...
        marriage_compatibility_props = PropertyList([
            ...
            Property('female_solar_datetime', PropertyType.STRING, default_value = ''),
            Property('female_lunar_datetime', PropertyType.STRING, default_value = '')])
        add_tool(('self.bazi.analyze_marriage_compatibility', '分析两人八字合婚，评估婚姻匹配度和相处模式。通过对比双方八字，分析婚姻匹配程度和注意事项。\\n使用场景：\\n1. 婚前合婚分析\\n2. 评估双方匹配度\\n3. 识别相处中的问题\\n4. 获取婚姻改善建议\\n5. 选择最佳结婚时机\\n\\n功能特点：\\n- 五行匹配分析\\n- 生肖相配评估\\n- 日柱组合判断\\n- 综合匹配评分\\n- 具体改善建议\\n\\n参数说明：\\n  male_solar_datetime: 男方公历时间\\n  male_lunar_datetime: 男方农历时间\\n  female_solar_datetime: 女方公历时间\\n  female_lunar_datetime: 女方农历时间\\n\\n注意：男女双方时间信息各自只需提供公历或农历其中一个', marriage_compatibility_props, analyze_marriage_compatibility))


_bazi_manager = None

def get_bazi_manager():
    '''
    获取八字管理器单例。
    '''
    pass
