# BACKEND AI (BACKEND AI) - Trợ Lý Giọng Nói Thông Minh Đa Nền Tảng (.NET 10 WPF & iOS MAUI)

Dự án Trợ lý giọng nói AI **Backend AI** (tên thương hiệu **BACKEND AI**) được phát triển trên nền tảng **.NET 10 (C# WPF)** dành cho Windows PC và **.NET MAUI** dành cho hệ điều hành iOS (iPhone/iPad), tuân thủ theo chuẩn giao thức **Tenclass / Xiaozhi Protocols**.
...
| Nhóm Tính năng | Lệnh Giọng nói Mẫu | Hành động Tự động của Backend AI |
| :--- | :--- | :--- |
| 🛡️ **Bảo vệ Ngân hàng** | *"Backend mở Vietcombank"*, *"Mở MoMo"*, *"Chuyển tiền"* | **Nghiêm cấm & Từ chối 100%** để bảo vệ an toàn tuyệt đối cho tài khoản tài chính người dùng. |
| 📸 **Camera & Máy ảnh** | *"Backend mở camera"*, *"Backend chụp ảnh"* | Tự động kích hoạt Máy ảnh iOS/PC ở chế độ Chụp ảnh. |
| 🎥 **Quay Video** | *"Backend quay video"*, *"Backend quay phim"* | Tự động mở chế độ Quay Video thời gian thực. |
| 🔊 **Điều chỉnh Âm lượng**| *"Backend tăng âm lượng"*, *"Giảm âm lượng"* | Tăng/giảm trực tiếp âm lượng giọng phát của Backend AI. |
| 📞 **Gọi điện thoại** | *"Backend gọi điện cho [SĐT/Tên]"* | Tự động mở trình gọi điện thoại native (`tel:`). |
| 💬 **Gọi / Nhắn Zalo** | *"Backend gọi Zalo cho [Tên]"*, *"Nhắn Zalo"* | Tự động kích hoạt ứng dụng Zalo. |
| 🗺️ **Bản đồ Dẫn đường** | *"Backend chỉ đường tới [Địa điểm]"* | Tự động mở Apple Maps dẫn đường Turn-by-Turn. |
| ⏰ **Xem Giờ & Ngày** | *"Backend mấy giờ rồi"*, *"Hôm nay ngày mấy"* | Phản hồi chính xác giờ và thứ ngày tháng Việt Nam. |
| ☀️ **Thời tiết Real-time** | *"Backend thời tiết hôm nay"* | Dự báo thời tiết nhiệt độ thực tế out loud. |
| 🚀 **Khởi chạy App** | *"Backend mở YouTube"*, *"Mở Facebook"*, *"Mở TikTok"* | Tự động khởi chạy ứng dụng tương ứng. |
...
- **Chế độ Rảnh tay liên tục (Auto Hands-Free Conversational Loop)**: Tự động lắng nghe câu tiếp theo ngay khi Backend trả lời xong mà không cần bấm nút.
